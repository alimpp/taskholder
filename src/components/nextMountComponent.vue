<template>
  <div class="nextMount container scrollbar">
    <div class="col-lg-12 app-flex-row">
      ...
      <i class="bi bi-search mx-2 app-btn-light" style="font-size:25px;" type="button"  data-bs-toggle="modal" data-bs-target="#searchTask"></i>
       ...
       <div class="card mx-2 my-2 opa-anim" style="width: 18rem;" v-for="data in dataSource" :key="data.id">
        <div class="card-body app-cart pointer">
          ...
          <div class="d-flex">
            ...
            <div class="dropdown">
              <i class="dropdown-toggle app-btn-light mx-1" style="font-size:17px;" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">Add To</i> 
              <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                <li><a class="dropdown-item pointer" @click="addToEmergency(data , data.id)">Emergency</a></li>
                <li><a class="dropdown-item pointer" @click="addToNextWeek(data, data.id)">Next Week</a></li>
              </ul>
